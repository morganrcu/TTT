 ...
 *  @{
 */
#ifndef __itkHessianSmoothed3DToOrientedObjectnessMeasureImageFilter_h
#define __itkHessianSmoothed3DToOrientedObjectnessMeasureImageFilter_h
...
template <class TOrientedObjectnessMeasurementFunction,typename  TPixel > class HessianSmoothed3DToOrientedObjectnessMeasureImageFilter :
		public ImageToImageFilter< Image< SymmetricSecondRankTensor< double, 3 >, 3 >,
																	Image< TPixel, 3 > >
{
public:
  /** Standard class typedefs. */
  typedef HessianSmoothed3DToOrientedObjectnessMeasureImageFilter Self;
  ...
  typedef TOrientedObjectnessMeasurementFunction OrientedObjectnessMeasurementFunctionType;
...
private:
  ...
  HessianSmoothed3DToOrientedObjectnessMeasureImageFilter(const Self&);

  void operator=(const Self&); //purposely not implemented

  typename EigenAnalysisFilterType::Pointer     m_SymmetricEigenValueFilter;
  typename OrientedObjectnessMeasurementFunctionType::Pointer m_ObjectnessMeasurementFunction;
...
#include "tttHessianSmoothed3DToOrientedObjectnessMeasureImageFilter.hxx"
#endif
