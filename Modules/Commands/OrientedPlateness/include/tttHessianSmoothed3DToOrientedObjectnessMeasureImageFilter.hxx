 ...
 *  @{
 */
#ifndef __itkHessianSmoothed3DToOrientedObjectnessMeasureImageFilter_txx
#define __itkHessianSmoothed3DToOrientedObjectnessMeasureImageFilter_txx

#include "tttHessianSmoothed3DToOrientedObjectnessMeasureImageFilter.h"
...
HessianSmoothed3DToOrientedObjectnessMeasureImageFilter<TObjectnessMeasurementFunction, TPixel >
::HessianSmoothed3DToOrientedObjectnessMeasureImageFilter()
{
...
template<class TObjectnessMeasurementFunction,typename TPixel>
void
HessianSmoothed3DToOrientedObjectnessMeasureImageFilter<TObjectnessMeasurementFunction,TPixel>::BeforeThreadedGenerateData(){
	  m_SymmetricEigenValueFilter->SetInput( this->GetInput() );
	  m_SymmetricEigenValueFilter->Update();
}
template <class TObjectnessMeasurementFunction, typename TPixel >
void 
HessianSmoothed3DToOrientedObjectnessMeasureImageFilter<TObjectnessMeasurementFunction, TPixel >::ThreadedGenerateData(const OutputRegionType& windowRegion, ThreadIdType threadId){
  itkDebugMacro(
...
template<class TObjectnessMeasurementFunction,typename TPixel>
void
HessianSmoothed3DToOrientedObjectnessMeasureImageFilter<TObjectnessMeasurementFunction,TPixel>::AfterThreadedGenerateData(){
}


template <class TObjectnessMeasurementFunction, typename TPixel >
void
HessianSmoothed3DToOrientedObjectnessMeasureImageFilter<TObjectnessMeasurementFunction, TPixel >::PrintSelf(std::ostream& os, Indent indent) const
{
