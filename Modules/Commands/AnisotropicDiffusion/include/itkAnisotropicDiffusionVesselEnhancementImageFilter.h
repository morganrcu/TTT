...
class ITK_EXPORT AnisotropicDiffusionPlateEnhancementImageFilter  
//  : public FiniteDifferenceImageFilter<TInputImage, TOutputImage>
: public DenseFiniteDifferenceImageFilter<TInputImage,TOutputImage>
{
public:
  /** Standard class typedefs */
  typedef AnisotropicDiffusionPlateEnhancementImageFilter Self;
...
//  typedef FiniteDifferenceImageFilter<TInputImage, TOutputImage> Superclass;
  ...
  typedef AnisotropicDiffusionPlateEnhancementFunction<InputImageType>  
...
private:
  ...
  AnisotropicDiffusionPlateEnhancementImageFilter(const Self&); 
  ...
  struct DenseFDThreadStruct
    {
    AnisotropicDiffusionPlateEnhancementImageFilter *Filter;
