/*
 * giaaHessian3DToPlatenessMeassureImageFilter.h
 *
...
template < class  TInputImage, class TPlatenessImage, class TDirectionImage=itk::Image<itk::FixedArray<double,3>,3> >

class Hessian3DToPlatenessMeasureImageFilter : public itk::ImageToImageFilter<TInputImage,TPlatenessImage>{

public:
  /** Standard class typedefs. */
  typedef Hessian3DToPlatenessMeasureImageFilter Self;

  typedef itk::ImageToImageFilter<TInputImage,TPlatenessImage>
                 Superclass;
  ...
  typedef typename PlatenessImageType::PixelType		 PlatenessPixelType;
  typedef typename DirectionImageType::PixelType		 DirectionPixelType;
...
//            InputImageType, EigenValueImageType >     EigenAnalysisFilterType;
  ...
  itkConceptMacro(DoubleConvertibleToOutputCheck,
                  (itk::Concept::Convertible<double, PlatenessPixelType>));
  /** End concept checking */
#endif

protected:
  Hessian3DToPlatenessMeasureImageFilter();
  ~Hessian3DToPlatenessMeasureImageFilter() {};
...
private:
  ...
  Hessian3DToPlatenessMeasureImageFilter(const Self&);
...
#include "giaaHessian3DToPlatenessMeasureImageFilter.hxx"
#endif
