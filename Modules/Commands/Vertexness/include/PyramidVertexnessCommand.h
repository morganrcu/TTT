...
#ifndef PYRAMIDVERTEXNESS_COMMAND_H_
#define PYRAMIDVERTEXNESS_COMMAND_H_
...
namespace ttt{
/**
 * \class PyramidVertexnessCommand
 * TODO
 */
class PyramidVertexnessCommand : public AppCommand{
...
public:
    ...
    typedef std::vector<VertexnessImageType::Pointer > VertexnessPyramidType;
...
private:
	 ...
	 *TODO
	 */
	VertexnessPyramidType m_VertexnessImages;
...
public:
	 ...
	 *TODO
	 */
	virtual ~PyramidVertexnessCommand(){
	 ...
	 * @return
	 */
	inline std::vector<VertexnessImageType::Pointer> GetVertexnessImages(){
		return m_VertexnessImages;
	}
	/**
	 * TODO
	 */
