 ...
 *
 *=========================================================================*/
#ifndef __tttL1RichardsonLucyDeconvolutionImageFilter_hxx
#define __tttL1RichardsonLucyDeconvolutionImageFilter_hxx

#include "tttL1RichardsonLucyDeconvolutionImageFilter.h"

namespace ttt
{

template< typename TInputImage, typename TKernelImage, typename TOutputImage, typename TInternalPrecision >
L1RichardsonLucyDeconvolutionImageFilter< TInputImage, TKernelImage, TOutputImage, TInternalPrecision >
             ...
             float iterationProgressWeight)
{
  ...
  m_RegularizerFilter = MultiplyFilterType::New();

  m_RegularizerFilter->SetNumberOfThreads(this->GetNumberOfThreads());
  m_RegularizerFilter->SetInput(m_MultiplyFilter->GetOutput());
  m_RegularizerFilter->InPlaceOn();
  m_RegularizerFilter->ReleaseDataFlagOn();
  m_RegularizerFilter->SetConstant(1.0f/(1+m_Lambda));
  progress->RegisterInternalFilter(m_MultiplyFilter,0.02f*iterationProgressWeight);
}
